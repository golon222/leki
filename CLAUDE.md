...
**585 + 51 firmware, 1201 (×6 pór doby) + 92 + 49 aplikacja, 48 zgodności,
119 reguł bazy, 314 kontroli audytu, 25 kontroli statycznych — 0 błędów.**
...
Stan: `PillBox.ino` **64% flasha** (1 262 311 B z 1,875 MB), `PillBoxTest.ino` 20%.
Zapas ~718 kB.
