...
| **Zakaz ruszania bloku pomiaru napięcia** | Zniesiony przez Kubę 2026-08-05. Blok wolno modyfikować. Audyt **nadal sprawdza** te cztery linie (`CALIBRATION_FACTOR = 0.921` i przeliczenia) — to tripwire przed przypadkową zmianą, nie zakaz. Zmieniasz świadomie? Popraw też `tests/audit_firmware.py`. |
