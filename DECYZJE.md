...
| # | O co chodziło | gdzie |
|---|---|---|
| **D97** | Przypomnienie o leku gra melodię z „ODDO” zamiast serii piknięć — fraza przeniesiona o 45 półtonów w górę, żeby zmieściła się w słyszalnym paśmie piezo (firmware `1.48.0`) | `pudelko` |
